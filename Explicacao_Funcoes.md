...
### Ciclo de Jogo e IA
*   **`check_game_over_state()`**: Analisa a vitória por extinção de peças inimigas, por falta de movimentos (bloqueio) ou por empates de regra (20 lances e repetição de posições).
