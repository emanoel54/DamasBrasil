...
img (peças e tabuleiro) e build (arquivos de compilação). ●​ Código-Fonte (.cpp / .hpp): Organizado 
...
voltados para o Linux ou simplesmente quer contribuir, você pode fazer uma doação de qualquer valor através do Pix. 

Chave Pix (E-mail): brasillinux20@gmail.com 
